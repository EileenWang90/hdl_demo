...
function test_single_engine {
    ...
    #eval ${cmd}
    echo ${cmd} >> /home/wyt/oc-accel/actions/hdl_single_engine/tests/tmp.txt
    if [ $? -ne 0 ]; then
        echo "cmd: ${cmd}"
...
/home/wyt/oc-accel/actions/hdl_single_engine/tests/process_bandwidth.awk hdl_single_engine.log
/home/wyt/oc-accel/actions/hdl_single_engine/tests/process_variance.awk hdl_single_engine.log
